...
import { ArrowLeft, Save, Users, Palette } from 'lucide-react'
...
export default function CreateGroupPage() {
  ...
  useEffect(() => {
    if (!authLoading) {
      if (!isAuthenticated) {
        router.push(`/login?redirectTo=${encodeURIComponent('/admin/groups/create')}`)
        return
      }
      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Add a new group to the system</p>
          </div>
        </div>
